...
if (!supabaseUrl || !supabaseAnonKey) {
  ...
  // (or solid dark) page locally with nothing rendered at all and no
  // visible error on the page itself: without these two values, the
  // Supabase client can't be created, which happens as soon as this file
  // is imported, before React has even mounted anything to the page. On
  // Vercel this never happens because the real values are set in the
  // project's environment variables there.
  //
