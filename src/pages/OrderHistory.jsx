...
const statusStyles = {
  ...
  return_requested: 'bg-gold/20 text-gold-deep dark:text-gold-deep dark:text-gold',
  returned: 'bg-espresso/10 text-espresso/60 dark:bg-cream/10 dark:text-cream/60',
  refund_pending: 'bg-gold/20 text-gold-deep dark:text-gold-deep dark:text-gold',
                  ...
                  <div className="border-t border-gold/10 mt-4 pt-4">
                    {returningOrderId === order.id ? (
                      ...
                      <button
                        ...
                        className="font-sans text-xs text-gold-deep dark:text-gold hover:underline"
                      >
                        Request a return
                      </button>
                    )}
