    ...
    <section className="bg-cream dark:bg-espresso transition-colors min-h-screen py-20 px-6">
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="flex flex-col gap-3 mb-10">
          ...
          <Link
            to="/wishlist"
            className="border border-gold/30 text-espresso dark:text-cream font-sans font-medium px-8 py-3 rounded-full hover:border-gold transition-colors text-center"
          >
            View My Wishlist
          </Link>
          <button
