...
const statusStyles = {
  pending_payment: 'bg-gold/20 text-gold-deep dark:text-gold-deep dark:text-gold',
      ...
      <div className="max-w-md mx-auto">
        <form onSubmit={handleSearch} className="flex flex-col gap-4 mb-8">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex items-center justify-center gap-2 bg-gold text-espresso font-sans font-medium px-8 py-4 rounded-full hover:bg-gold-light transition-colors disabled:opacity-40"
          >
        ...
        {result && (
          <div className="border border-gold/20 rounded-2xl p-6">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 font-sans text-xs text-gold-deep dark:text-gold hover:underline"
            >
