  ...
  return (
    <header className="w-full bg-cream dark:bg-espresso border-b border-gold/20 transition-colors sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-4 md:gap-5 text-espresso dark:text-cream">
          <Search
      ...
      {menuOpen && (
        <div className="fixed inset-0 bg-cream dark:bg-espresso z-50 flex flex-col p-6">
          ...
          <nav className="flex flex-col gap-6 font-display italic text-3xl text-espresso dark:text-cream">
            {links.map((link) => (
              <Link
                key={link.label}
                to={link.to}
